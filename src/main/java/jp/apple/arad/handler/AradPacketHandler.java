...
public final class AradPacketHandler {
    ...
    public static final SimpleNetworkWrapper CHANNEL = NetworkRegistry.INSTANCE.newSimpleChannel(AradCore.MOD_ID);
    ...
    public static void register() {
        ...
        CHANNEL.registerMessage(PacketSpeedLimitSignConfig.Handler.class, PacketSpeedLimitSignConfig.class, id++,
                Side.SERVER);
        CHANNEL.registerMessage(PacketSectionMarkerConfig.Handler.class, PacketSectionMarkerConfig.class, id++,
                Side.SERVER);
